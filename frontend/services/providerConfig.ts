 ...
 */
export function getAnimeProviderRanking(): VideoProviderName[] {
  return ANIME_PROVIDERS
    .filter(p => p.sourcesWork) // Only providers with working sources
 ...
 */
export function getMovieProviderRanking(): VideoProviderName[] {
 ...
 */
export const DEFAULT_ANIME_PROVIDERS: VideoProviderName[] = ['animepahe', 'animekai'];
export const DEFAULT_MOVIE_PROVIDERS: VideoProviderName[] = ['flixhq', 'goku'];
